...
# Global variables
PATH_REFERENCE = "/home/DATA/Candida_albicans_reference/C_albicans_SC5314_version_A22-s07-m01-r183_chromosomes_hapA.fasta"
FASTQ_THREADS = 8
...
def writeConfig(dataframe):
    ...
    for dset in sets:
        ...
        FASTQ_PHRED = df_['encoding'].head(1).values[0].astype(int)
